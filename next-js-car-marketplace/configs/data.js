...
export const carDetails = {
  carDetails: [
    ...
    { label: "Category", name: "category", fieldType: "dropdown", required: true, options: ["sedan", "suv", "pickup"], column: 1, icon: FaCar },
    { label: "Condition", name: "condition", fieldType: "dropdown", required: true, options: ["New", "Used"], column: 1, icon: FaCheckCircle },
    { label: "Type", name: "type", fieldType: "dropdown", required: true, options: ["electric", "hybrid", "petrol"], column: 1, icon: FaBolt },
    { label: "Make", name: "make", fieldType: "dropdown", required: true, options: ["BMW", "BYD", "Chevrolet", "Ford", "Honda", "Hyundai", "Kia", "Land Rover", "Lifan", "Mercedes-Benz", "Mitsubishi", "Nissan", "Suzuki", "Toyota", "Volkswagen"], column: 1, icon: FaIndustry },
